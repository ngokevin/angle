...
function initcomponent () {
  ...
  glob.sync('templates/component/*').forEach(file => {
    cp('-r', file, './.component');
  });
  cd('.component');
  rm('./dist/.gitkeep');
...
function customize () {
  ...
  function run (answers) {
    ls(['LICENSE', 'package.json', 'README.md', 'index.js', 'examples/index.html', 'examples/basic/index.html', 'tests/index.test.js']).forEach(function (file) {
